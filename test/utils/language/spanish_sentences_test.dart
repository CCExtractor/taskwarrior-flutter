...
void main() {
  ...
  test('should provide correct Spanish translations', () {
    ...
    expect(spanish.navDrawerStatistics, 'Estadísticas');
    ...
    expect(spanish.reportsPageTitle, 'Estadísticas');
    ...
    expect(spanish.syncServerCredentials, 'Credenciales de TaskChampion');
