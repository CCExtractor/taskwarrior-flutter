...
class _HomePageBodyState extends State<HomePageBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
        ...
        child: Container(
          color: tColors.dialogBackgroundColor,        child: Padding(
            ...
            child: Obx(
              () => Column(
                children: <Widget>[
                  ...
                  Visibility(
                    visible: !widget.controller.taskchampion.value &&
                      !widget.controller.taskReplica.value,
                    child: Expanded(
                      child: Scrollbar(
                        child: Obx(
                          () => TasksBuilder(
                ...
                Visibility(
                    visible: widget.controller.taskReplica.value,
                    child: Expanded(
                        child: Scrollbar(
                      child: TaskReplicaViewBuilder(
                        replicaTasks: widget.controller.tasksFromReplica,
                        pendingFilter: widget.controller.pendingFilter.value,
                        selectedSort: widget.controller.selectedSort.value,
                        project: widget.controller.projectFilter.value,
                      ),)))
